...
INSERT INTO abrigos (nome, endereco, cep, cidade, responsavel, telefone, email, capacidade, ocupacao) VALUES
    ('Abrigo Esperança', 'Av. Boqueirão, 2550 - Igara', '92032-421', 'Canoas', 'Maria Silva', '51 99999-1111', 'maria@esperanca.org', 600, 35),
    ...
    ('Abrigo Renascer', 'Av. Presidente Roosevelt, 2500', '92420-000', 'Esteio', 'Marcos Teixeira', '51 99999-8888', 'marcos@casadeamigos.org', 600, 25);

INSERT INTO armazem (centro_distribuicao_id, abrigo_id) VALUES
    (1, 1),
    (1, 2),
    (2, 3),
    (3, 4),
...
INSERT INTO produtos (categoria, item, sexo, tamanho, quantidade, armazem_id) VALUES
    ('ROUPA', 'AGASALHO', 'M', 'M', 20, 1),
    ('ROUPA', 'AGASALHO', 'F', 'P', 20, 1),
    ('ROUPA', 'CAMISA', 'M', 'G', 15, 1),
    ('ROUPA', 'CAMISA', 'F', 'M', 15, 1),
    ('HIGIENE', 'SABONETE', NULL, NULL, 20, 1),
    ('HIGIENE', 'ESCOVA_DE_DENTES', NULL, NULL, 15, 1),
    ('HIGIENE', 'PASTA_DE_DENTES', NULL, NULL, 20, 1),
    ('HIGIENE', 'ABSORVENTE', NULL, NULL, 15, 1),
    ('ALIMENTO', 'ARROZ', NULL, NULL, 20, 1),
    ('ALIMENTO', 'FEIJAO', NULL, NULL, 25, 1),
    ('ALIMENTO', 'AGUA', NULL, NULL, 50, 1),
    ('LIMPEZA', 'ALCOOL', NULL, NULL, 5, 1),
    ('LIMPEZA', 'AGUA_SANITARIA', NULL, NULL, 5, 1);


INSERT INTO produtos (categoria, item, sexo, tamanho, quantidade, armazem_id) VALUES
    ('ROUPA', 'AGASALHO', 'M', 'M', 10, 2),
    ('ROUPA', 'AGASALHO', 'F', 'P', 10, 2),
    ('ROUPA', 'CAMISA', 'M', 'G', 10, 2),
    ('ROUPA', 'CAMISA', 'F', 'M', 10, 2),
    ('HIGIENE', 'SABONETE', NULL, NULL, 10, 2),
    ('HIGIENE', 'ESCOVA_DE_DENTES', NULL, NULL, 10, 2),
    ('HIGIENE', 'PASTA_DE_DENTES', NULL, NULL, 10, 2),
    ('HIGIENE', 'ABSORVENTE', NULL, NULL, 10, 2),
    ('ALIMENTO', 'ARROZ', NULL, NULL, 10, 2),
    ('ALIMENTO', 'FEIJAO', NULL, NULL, 10, 2),
    ('ALIMENTO', 'LEITE', NULL, NULL, 20, 2),
...
INSERT INTO produtos (categoria, item, sexo, tamanho, quantidade, armazem_id) VALUES
    ...
    ('HIGIENE', 'SABONETE', NULL, NULL, 40, 3),
    ('HIGIENE', 'ESCOVA_DE_DENTES', NULL, NULL, 30, 3),
    ('HIGIENE', 'PASTA_DE_DENTES', NULL, NULL, 30, 3),
    ('HIGIENE', 'ABSORVENTE', NULL, NULL, 30, 3),
    ('ALIMENTO', 'ARROZ', NULL, NULL, 40, 3),
    ('ALIMENTO', 'FEIJAO', NULL, NULL, 45, 3),
    ('ALIMENTO', 'LEITE', NULL, NULL, 45, 3),
    ('ALIMENTO', 'AGUA', NULL, NULL, 90, 3),
    ('LIMPEZA', 'ALCOOL', NULL, NULL, 10, 3),
